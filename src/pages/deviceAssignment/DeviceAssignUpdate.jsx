...
function DeviceAssignUpdate() {
  ...
  const { mutate: updateDeviceEnrollment, isLoading } = useMutation({
    mutationFn: (data) => {
  ...
  const onSubmit = (formData) => {
    updateDeviceEnrollment(formData);
  };
...
export default DeviceAssignUpdate;
